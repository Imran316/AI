package imran.com.timetable.login;
...
public class EditProfileActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    void setupUIViews(){
        ChangeName = (EditText)findViewById(R.id.etChangeName);
        ChangeRoll = (EditText)findViewById(R.id.etChangeRollno);
        ChangeBatchTV = (TextView)findViewById(R.id.tvChangeBatch);
        ChangeRollTV = (TextView)findViewById(R.id.tvChangeRollNo);
        ChangeClassTV = (TextView)findViewById(R.id.tvChangeClass);
        ChangeClass = (Spinner) findViewById(R.id.spnClass);
        ChangeBatch = (Spinner) findViewById(R.id.spnBatch);
        ChangeSave = (Button) findViewById(R.id.btnSave);
    }
