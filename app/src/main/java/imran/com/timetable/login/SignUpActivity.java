...
public class SignUpActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void setUIViews(){
        SignAs = (Spinner)findViewById(R.id.spnSignAs);
        Class = (Spinner)findViewById(R.id.spnClass);
        Batch = (Spinner)findViewById(R.id.spnBatch);

        ProfName = (Spinner)findViewById(R.id.spnProfName);
        ...
        ClassTV = (TextView)findViewById(R.id.tvClass);
        BatchTV = (TextView)findViewById(R.id.tvBatch);
