...
import imran.com.timetable.UploadTImetable;
...
public class TimetableActivity extends AppCompatActivity {
    ...
    {
        recyclerView=(RecyclerView)findViewById(R.id.rvMon);
        recyclerView1=(RecyclerView)findViewById(R.id.rvTue);
        recyclerView2=(RecyclerView)findViewById(R.id.rvWed);
        recyclerView3=(RecyclerView)findViewById(R.id.rvThu);
        recyclerView4=(RecyclerView)findViewById(R.id.rvFri);
    }
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>
    {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder
        {
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                Professor=(TextView)itemView.findViewById(R.id.tvProfessor);
            }
        }
    }
